...
/**
 * Dagoma specific texts
 */
#define MSG_LCD_OK                          _UxGT("OK")
#define MSG_PINCH                           _UxGT("Pincez la feuille")
#define MSG_SET_OFFSET                      _UxGT("en réglant l'offset")
...
#define MSG_PARALLEL_X                      _UxGT("Parallèle X")
#define MSG_Z_OFFSET                        _UxGT("Régl. Z-Offset")
#define MSG_REINIT                          _UxGT("Réinitialiser")
#define MSG_PREPARE_ADVANCED                _UxGT("Options avancées")
#define MSG_PLEASE_WAIT                     _UxGT("Patientez svp...")
#define MSG_PARAMETERS                      _UxGT("   Paramètres")
#define MSG_SAVED                           _UxGT("   Sauvegardés")
